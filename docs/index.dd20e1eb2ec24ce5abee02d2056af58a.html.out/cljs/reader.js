...
var len__7950__auto___12896 = arguments.length;
var i__7951__auto___12897 = (0);
while(true){
if((i__7951__auto___12897 < len__7950__auto___12896)){
args__7957__auto__.push((arguments[i__7951__auto___12897]));

var G__12898 = (i__7951__auto___12897 + (1));
i__7951__auto___12897 = G__12898;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq12894){
var G__12895 = cljs.core.first(seq12894);
var seq12894__$1 = cljs.core.next(seq12894);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__12895,seq12894__$1);
});
...
var G__12899 = (function (){
sb.append(ch);

return sb;
})()
;
var G__12900 = cljs.reader.read_char(rdr);
sb = G__12899;
ch = G__12900;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__12903 = (groups[(6)]);
var G__12904 = (10);
return parseInt(G__12903,G__12904);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__12905 = cljs.reader.read_char(rdr);
ch = G__12905;
continue;
} else {
return ch;
...
var G__12906 = (((mret === rdr))?a:(function (){
a.push(mret);
...
if((i > (0))){
var G__12908 = (i - (1));
var G__12909 = r.cljs$core$ICollection$_conj$arity$2(null,(arr[(i - (1))]));
i = G__12908;
r = G__12909;
continue;
} else {
...
;
var G__12913 = cljs.reader.read_char(reader);
buffer = G__12912;
ch = G__12913;
continue;
} else {
...
var G__12914 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__12915 = cljs.reader.read_char(reader);
buffer = G__12914;
ch = G__12915;
continue;
...
var G__12920 = (function (){var G__12918 = buffer;
G__12918.append(nch);

return G__12918;
})();
var G__12921 = cljs.reader.read_char(reader);
buffer = G__12920;
ch = G__12921;
continue;
}
...
var G__12922 = (function (){var G__12919 = buffer;
G__12919.append(ch);

return G__12919;
})();
var G__12923 = cljs.reader.read_char(reader);
buffer = G__12922;
ch = G__12923;
continue;
...
var G__12930 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
...
if((res === reader)){
var G__12934 = reader;
var G__12935 = eof_is_error;
var G__12936 = sentinel;
var G__12937 = is_recursive;
reader = G__12934;
eof_is_error = G__12935;
sentinel = G__12936;
is_recursive = G__12937;
continue;
} else {
return res;
}
...
var vec__12944 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12944,(10),null);
var v = vec__12944;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__12947 = months__$1;
var G__12948 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__12947,G__12948) : cljs.reader.days_in_month.call(null,G__12947,G__12948));
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__12952 = temp__4655__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12952,(7),null);
...
var arr = [];
var seq__12971_12987 = cljs.core.seq(form);
var chunk__12972_12988 = null;
var count__12973_12989 = (0);
var i__12974_12990 = (0);
while(true){
if((i__12974_12990 < count__12973_12989)){
var x_12991 = chunk__12972_12988.cljs$core$IIndexed$_nth$arity$2(null,i__12974_12990);
arr.push(x_12991);

var G__12992 = seq__12971_12987;
var G__12993 = chunk__12972_12988;
var G__12994 = count__12973_12989;
var G__12995 = (i__12974_12990 + (1));
seq__12971_12987 = G__12992;
chunk__12972_12988 = G__12993;
count__12973_12989 = G__12994;
i__12974_12990 = G__12995;
continue;
} else {
var temp__4657__auto___12996 = cljs.core.seq(seq__12971_12987);
if(temp__4657__auto___12996){
var seq__12971_12997__$1 = temp__4657__auto___12996;
if(cljs.core.chunked_seq_QMARK_(seq__12971_12997__$1)){
var c__7656__auto___12998 = cljs.core.chunk_first(seq__12971_12997__$1);
var G__12999 = cljs.core.chunk_rest(seq__12971_12997__$1);
var G__13000 = c__7656__auto___12998;
var G__13001 = cljs.core.count(c__7656__auto___12998);
var G__13002 = (0);
seq__12971_12987 = G__12999;
chunk__12972_12988 = G__13000;
count__12973_12989 = G__13001;
i__12974_12990 = G__13002;
continue;
} else {
var x_13003 = cljs.core.first(seq__12971_12997__$1);
arr.push(x_13003);

var G__13004 = cljs.core.next(seq__12971_12997__$1);
var G__13005 = null;
var G__13006 = (0);
var G__13007 = (0);
seq__12971_12987 = G__13004;
chunk__12972_12988 = G__13005;
count__12973_12989 = G__13006;
i__12974_12990 = G__13007;
continue;
}
} else {
}
...
var obj = {};
var seq__12977_13008 = cljs.core.seq(form);
var chunk__12978_13009 = null;
var count__12979_13010 = (0);
var i__12980_13011 = (0);
while(true){
if((i__12980_13011 < count__12979_13010)){
var vec__12981_13012 = chunk__12978_13009.cljs$core$IIndexed$_nth$arity$2(null,i__12980_13011);
var k_13013 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12981_13012,(0),null);
var v_13014 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12981_13012,(1),null);
(obj[cljs.core.name(k_13013)] = v_13014);

var G__13015 = seq__12977_13008;
var G__13016 = chunk__12978_13009;
var G__13017 = count__12979_13010;
var G__13018 = (i__12980_13011 + (1));
seq__12977_13008 = G__13015;
chunk__12978_13009 = G__13016;
count__12979_13010 = G__13017;
i__12980_13011 = G__13018;
continue;
} else {
var temp__4657__auto___13019 = cljs.core.seq(seq__12977_13008);
if(temp__4657__auto___13019){
var seq__12977_13020__$1 = temp__4657__auto___13019;
if(cljs.core.chunked_seq_QMARK_(seq__12977_13020__$1)){
var c__7656__auto___13021 = cljs.core.chunk_first(seq__12977_13020__$1);
var G__13022 = cljs.core.chunk_rest(seq__12977_13020__$1);
var G__13023 = c__7656__auto___13021;
var G__13024 = cljs.core.count(c__7656__auto___13021);
var G__13025 = (0);
seq__12977_13008 = G__13022;
chunk__12978_13009 = G__13023;
count__12979_13010 = G__13024;
i__12980_13011 = G__13025;
continue;
} else {
var vec__12984_13026 = cljs.core.first(seq__12977_13020__$1);
var k_13027 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12984_13026,(0),null);
var v_13028 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12984_13026,(1),null);
(obj[cljs.core.name(k_13027)] = v_13028);

var G__13029 = cljs.core.next(seq__12977_13020__$1);
var G__13030 = null;
var G__13031 = (0);
var G__13032 = (0);
seq__12977_13008 = G__13029;
chunk__12978_13009 = G__13030;
count__12979_13010 = G__13031;
i__12980_13011 = G__13032;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__13033 = new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null);
...
var G__13037 = cljs.reader.read(rdr,true,null,false);
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__13037) : pfn.call(null,G__13037));
} else {
if(cljs.core.truth_(dfn)){
var G__13038 = tag;
var G__13039 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__13038,G__13039) : dfn.call(null,G__13038,G__13039));
} else {
