...
var amentum$doc$views$modules$dropdown__delegate = function (args__13753__auto__){
var vec__15420 = hoplon.core.parse_args(args__13753__auto__);
...
while (G__15435__i < G__15435__a.length) {G__15435__a[G__15435__i] = arguments[G__15435__i + 0]; ++G__15435__i;}
  args__13753__auto__ = new cljs.core.IndexedSeq(G__15435__a,0);
} 
return amentum$doc$views$modules$dropdown__delegate.call(this,args__13753__auto__);};
...
var args__13753__auto__ = cljs.core.seq(arglist__15436);
return amentum$doc$views$modules$dropdown__delegate(args__13753__auto__);
});
...
var amentum$doc$views$modules$sidebar__delegate = function (args__13753__auto__){
var vec__15440 = hoplon.core.parse_args(args__13753__auto__);
return null;
};
...
while (G__15443__i < G__15443__a.length) {G__15443__a[G__15443__i] = arguments[G__15443__i + 0]; ++G__15443__i;}
  args__13753__auto__ = new cljs.core.IndexedSeq(G__15443__a,0);
} 
return amentum$doc$views$modules$sidebar__delegate.call(this,args__13753__auto__);};
...
var args__13753__auto__ = cljs.core.seq(arglist__15444);
return amentum$doc$views$modules$sidebar__delegate(args__13753__auto__);
});
