...
var len__7950__auto___12841 = arguments.length;
var i__7951__auto___12842 = (0);
while(true){
if((i__7951__auto___12842 < len__7950__auto___12841)){
args__7957__auto__.push((arguments[i__7951__auto___12842]));

var G__12843 = (i__7951__auto___12842 + (1));
i__7951__auto___12842 = G__12843;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq12839){
var G__12840 = cljs.core.first(seq12839);
var seq12839__$1 = cljs.core.next(seq12839);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__12840,seq12839__$1);
});
...
var G__12844 = (function (){
sb.append(ch);

return sb;
})()
;
var G__12845 = cljs.reader.read_char(rdr);
sb = G__12844;
ch = G__12845;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__12848 = (groups[(6)]);
var G__12849 = (10);
...
var G__12850 = cljs.reader.read_char(rdr);
ch = G__12850;
continue;
} else {
return ch;
...
var G__12851 = (((mret === rdr))?a:(function (){
a.push(mret);
...
if((i > (0))){
var G__12853 = (i - (1));
var G__12854 = r.cljs$core$ICollection$_conj$arity$2(null,(arr[(i - (1))]));
i = G__12853;
r = G__12854;
continue;
} else {
...
var G__12859 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__12860 = cljs.reader.read_char(reader);
buffer = G__12859;
ch = G__12860;
continue;
...
var G__12865 = (function (){var G__12863 = buffer;
G__12863.append(nch);
...
var G__12867 = (function (){var G__12864 = buffer;
G__12864.append(ch);
...
var G__12875 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
...
var vec__12889 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12889,(10),null);
var v = vec__12889;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__12892 = months__$1;
var G__12893 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__12892,G__12893) : cljs.reader.days_in_month.call(null,G__12892,G__12893));
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__12897 = temp__4655__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12897,(7),null);
...
var arr = [];
var seq__12916_12932 = cljs.core.seq(form);
var chunk__12917_12933 = null;
var count__12918_12934 = (0);
var i__12919_12935 = (0);
while(true){
if((i__12919_12935 < count__12918_12934)){
var x_12936 = chunk__12917_12933.cljs$core$IIndexed$_nth$arity$2(null,i__12919_12935);
arr.push(x_12936);

var G__12937 = seq__12916_12932;
var G__12938 = chunk__12917_12933;
var G__12939 = count__12918_12934;
var G__12940 = (i__12919_12935 + (1));
seq__12916_12932 = G__12937;
chunk__12917_12933 = G__12938;
count__12918_12934 = G__12939;
i__12919_12935 = G__12940;
continue;
} else {
var temp__4657__auto___12941 = cljs.core.seq(seq__12916_12932);
if(temp__4657__auto___12941){
var seq__12916_12942__$1 = temp__4657__auto___12941;
if(cljs.core.chunked_seq_QMARK_(seq__12916_12942__$1)){
var c__7656__auto___12943 = cljs.core.chunk_first(seq__12916_12942__$1);
var G__12944 = cljs.core.chunk_rest(seq__12916_12942__$1);
var G__12945 = c__7656__auto___12943;
var G__12946 = cljs.core.count(c__7656__auto___12943);
var G__12947 = (0);
seq__12916_12932 = G__12944;
chunk__12917_12933 = G__12945;
count__12918_12934 = G__12946;
i__12919_12935 = G__12947;
continue;
} else {
var x_12948 = cljs.core.first(seq__12916_12942__$1);
arr.push(x_12948);

var G__12949 = cljs.core.next(seq__12916_12942__$1);
var G__12950 = null;
var G__12951 = (0);
var G__12952 = (0);
seq__12916_12932 = G__12949;
chunk__12917_12933 = G__12950;
count__12918_12934 = G__12951;
i__12919_12935 = G__12952;
continue;
}
} else {
}
...
var obj = {};
var seq__12922_12953 = cljs.core.seq(form);
var chunk__12923_12954 = null;
var count__12924_12955 = (0);
var i__12925_12956 = (0);
while(true){
if((i__12925_12956 < count__12924_12955)){
var vec__12926_12957 = chunk__12923_12954.cljs$core$IIndexed$_nth$arity$2(null,i__12925_12956);
var k_12958 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12926_12957,(0),null);
var v_12959 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12926_12957,(1),null);
(obj[cljs.core.name(k_12958)] = v_12959);

var G__12960 = seq__12922_12953;
var G__12961 = chunk__12923_12954;
var G__12962 = count__12924_12955;
var G__12963 = (i__12925_12956 + (1));
seq__12922_12953 = G__12960;
chunk__12923_12954 = G__12961;
count__12924_12955 = G__12962;
i__12925_12956 = G__12963;
continue;
} else {
var temp__4657__auto___12964 = cljs.core.seq(seq__12922_12953);
if(temp__4657__auto___12964){
var seq__12922_12965__$1 = temp__4657__auto___12964;
if(cljs.core.chunked_seq_QMARK_(seq__12922_12965__$1)){
var c__7656__auto___12966 = cljs.core.chunk_first(seq__12922_12965__$1);
var G__12967 = cljs.core.chunk_rest(seq__12922_12965__$1);
var G__12968 = c__7656__auto___12966;
var G__12969 = cljs.core.count(c__7656__auto___12966);
var G__12970 = (0);
seq__12922_12953 = G__12967;
chunk__12923_12954 = G__12968;
count__12924_12955 = G__12969;
i__12925_12956 = G__12970;
continue;
} else {
var vec__12929_12971 = cljs.core.first(seq__12922_12965__$1);
var k_12972 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12929_12971,(0),null);
var v_12973 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12929_12971,(1),null);
(obj[cljs.core.name(k_12972)] = v_12973);

var G__12974 = cljs.core.next(seq__12922_12965__$1);
var G__12975 = null;
var G__12976 = (0);
var G__12977 = (0);
seq__12922_12953 = G__12974;
chunk__12923_12954 = G__12975;
count__12924_12955 = G__12976;
i__12925_12956 = G__12977;
continue;
}
} else {
}
