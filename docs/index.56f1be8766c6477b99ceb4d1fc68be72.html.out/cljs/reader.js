...
var len__7950__auto___12839 = arguments.length;
var i__7951__auto___12840 = (0);
while(true){
if((i__7951__auto___12840 < len__7950__auto___12839)){
args__7957__auto__.push((arguments[i__7951__auto___12840]));

var G__12841 = (i__7951__auto___12840 + (1));
i__7951__auto___12840 = G__12841;
continue;
} else {
}
break;
...
cljs.reader.reader_error.cljs$lang$applyTo = (function (seq12837){
var G__12838 = cljs.core.first(seq12837);
var seq12837__$1 = cljs.core.next(seq12837);
return cljs.reader.reader_error.cljs$core$IFn$_invoke$arity$variadic(G__12838,seq12837__$1);
});
...
;
var G__12843 = cljs.reader.read_char(rdr);
sb = G__12842;
ch = G__12843;
continue;
}
...
var a = (cljs.core.truth_((groups[(3)]))?[(groups[(3)]),(10)]:(cljs.core.truth_((groups[(4)]))?[(groups[(4)]),(16)]:(cljs.core.truth_((groups[(5)]))?[(groups[(5)]),(8)]:(cljs.core.truth_((groups[(6)]))?[(groups[(7)]),(function (){var G__12846 = (groups[(6)]);
var G__12847 = (10);
return parseInt(G__12846,G__12847);
})()]:[null,null]
))));
var n = (a[(0)]);
var radix = (a[(1)]);
...
var G__12848 = cljs.reader.read_char(rdr);
ch = G__12848;
continue;
} else {
return ch;
...
var G__12849 = (((mret === rdr))?a:(function (){
a.push(mret);
...
if((i > (0))){
var G__12851 = (i - (1));
var G__12852 = r.cljs$core$ICollection$_conj$arity$2(null,(arr[(i - (1))]));
i = G__12851;
r = G__12852;
continue;
} else {
...
var G__12857 = (function (){
buffer.append(ch);

return buffer;
})()
;
var G__12858 = cljs.reader.read_char(reader);
buffer = G__12857;
ch = G__12858;
continue;
...
var G__12863 = (function (){var G__12861 = buffer;
G__12861.append(nch);
...
var G__12865 = (function (){var G__12862 = buffer;
G__12862.append(ch);
...
var G__12869 = reader;
var G__12870 = eof_is_error;
var G__12871 = sentinel;
var G__12872 = is_recursive;
reader = G__12869;
eof_is_error = G__12870;
sentinel = G__12871;
is_recursive = G__12872;
continue;
} else {
if(cljs.reader.comment_prefix_QMARK_(ch)){
var G__12873 = (cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.read_comment.cljs$core$IFn$_invoke$arity$2(reader,ch) : cljs.reader.read_comment.call(null,reader,ch));
var G__12874 = eof_is_error;
var G__12875 = sentinel;
var G__12876 = is_recursive;
reader = G__12873;
eof_is_error = G__12874;
sentinel = G__12875;
is_recursive = G__12876;
continue;
} else {
...
if((res === reader)){
var G__12877 = reader;
var G__12878 = eof_is_error;
var G__12879 = sentinel;
var G__12880 = is_recursive;
reader = G__12877;
eof_is_error = G__12878;
sentinel = G__12879;
is_recursive = G__12880;
continue;
} else {
return res;
}
...
var vec__12887 = cljs.core.re_matches(cljs.reader.timestamp_regex,s);
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(0),null);
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(1),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(2),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(3),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(4),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(5),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(6),null);
var fraction = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(7),null);
var offset_sign = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(8),null);
var offset_hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(9),null);
var offset_minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12887,(10),null);
var v = vec__12887;
if(cljs.core.not(v)){
...
return new cljs.core.PersistentVector(null, 8, 5, cljs.core.PersistentVector.EMPTY_NODE, [years__$1,cljs.reader.check((1),months__$1,(12),"timestamp month field must be in range 1..12"),cljs.reader.check((1),days__$1,(function (){var G__12890 = months__$1;
var G__12891 = cljs.reader.leap_year_QMARK_(years__$1);
return (cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2 ? cljs.reader.days_in_month.cljs$core$IFn$_invoke$arity$2(G__12890,G__12891) : cljs.reader.days_in_month.call(null,G__12890,G__12891));
...
if(cljs.core.truth_(temp__4655__auto__)){
var vec__12895 = temp__4655__auto__;
var years = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(0),null);
var months = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(1),null);
var days = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(2),null);
var hours = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(3),null);
var minutes = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(4),null);
var seconds = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(5),null);
var ms = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(6),null);
var offset = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12895,(7),null);
...
var arr = [];
var seq__12914_12930 = cljs.core.seq(form);
var chunk__12915_12931 = null;
var count__12916_12932 = (0);
var i__12917_12933 = (0);
while(true){
if((i__12917_12933 < count__12916_12932)){
var x_12934 = chunk__12915_12931.cljs$core$IIndexed$_nth$arity$2(null,i__12917_12933);
arr.push(x_12934);

var G__12935 = seq__12914_12930;
var G__12936 = chunk__12915_12931;
var G__12937 = count__12916_12932;
var G__12938 = (i__12917_12933 + (1));
seq__12914_12930 = G__12935;
chunk__12915_12931 = G__12936;
count__12916_12932 = G__12937;
i__12917_12933 = G__12938;
continue;
} else {
var temp__4657__auto___12939 = cljs.core.seq(seq__12914_12930);
if(temp__4657__auto___12939){
var seq__12914_12940__$1 = temp__4657__auto___12939;
if(cljs.core.chunked_seq_QMARK_(seq__12914_12940__$1)){
var c__7656__auto___12941 = cljs.core.chunk_first(seq__12914_12940__$1);
var G__12942 = cljs.core.chunk_rest(seq__12914_12940__$1);
var G__12943 = c__7656__auto___12941;
var G__12944 = cljs.core.count(c__7656__auto___12941);
var G__12945 = (0);
seq__12914_12930 = G__12942;
chunk__12915_12931 = G__12943;
count__12916_12932 = G__12944;
i__12917_12933 = G__12945;
continue;
} else {
var x_12946 = cljs.core.first(seq__12914_12940__$1);
arr.push(x_12946);

var G__12947 = cljs.core.next(seq__12914_12940__$1);
var G__12948 = null;
var G__12949 = (0);
var G__12950 = (0);
seq__12914_12930 = G__12947;
chunk__12915_12931 = G__12948;
count__12916_12932 = G__12949;
i__12917_12933 = G__12950;
continue;
}
} else {
}
...
var obj = {};
var seq__12920_12951 = cljs.core.seq(form);
var chunk__12921_12952 = null;
var count__12922_12953 = (0);
var i__12923_12954 = (0);
while(true){
if((i__12923_12954 < count__12922_12953)){
var vec__12924_12955 = chunk__12921_12952.cljs$core$IIndexed$_nth$arity$2(null,i__12923_12954);
var k_12956 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12924_12955,(0),null);
var v_12957 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12924_12955,(1),null);
(obj[cljs.core.name(k_12956)] = v_12957);

var G__12958 = seq__12920_12951;
var G__12959 = chunk__12921_12952;
var G__12960 = count__12922_12953;
var G__12961 = (i__12923_12954 + (1));
seq__12920_12951 = G__12958;
chunk__12921_12952 = G__12959;
count__12922_12953 = G__12960;
i__12923_12954 = G__12961;
continue;
} else {
var temp__4657__auto___12962 = cljs.core.seq(seq__12920_12951);
if(temp__4657__auto___12962){
var seq__12920_12963__$1 = temp__4657__auto___12962;
if(cljs.core.chunked_seq_QMARK_(seq__12920_12963__$1)){
var c__7656__auto___12964 = cljs.core.chunk_first(seq__12920_12963__$1);
var G__12965 = cljs.core.chunk_rest(seq__12920_12963__$1);
var G__12966 = c__7656__auto___12964;
var G__12967 = cljs.core.count(c__7656__auto___12964);
var G__12968 = (0);
seq__12920_12951 = G__12965;
chunk__12921_12952 = G__12966;
count__12922_12953 = G__12967;
i__12923_12954 = G__12968;
continue;
} else {
var vec__12927_12969 = cljs.core.first(seq__12920_12963__$1);
var k_12970 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12927_12969,(0),null);
var v_12971 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__12927_12969,(1),null);
(obj[cljs.core.name(k_12970)] = v_12971);

var G__12972 = cljs.core.next(seq__12920_12963__$1);
var G__12973 = null;
var G__12974 = (0);
var G__12975 = (0);
seq__12920_12951 = G__12972;
chunk__12921_12952 = G__12973;
count__12922_12953 = G__12974;
i__12923_12954 = G__12975;
continue;
}
} else {
}
...
cljs.reader._STAR_tag_table_STAR_ = (function (){var G__12976 = new cljs.core.PersistentArrayMap(null, 4, ["inst",cljs.reader.read_date,"uuid",cljs.reader.read_uuid,"queue",cljs.reader.read_queue,"js",cljs.reader.read_js], null);
...
return (pfn.cljs$core$IFn$_invoke$arity$1 ? pfn.cljs$core$IFn$_invoke$arity$1(G__12980) : pfn.call(null,G__12980));
} else {
if(cljs.core.truth_(dfn)){
var G__12981 = tag;
var G__12982 = cljs.reader.read(rdr,true,null,false);
return (dfn.cljs$core$IFn$_invoke$arity$2 ? dfn.cljs$core$IFn$_invoke$arity$2(G__12981,G__12982) : dfn.call(null,G__12981,G__12982));
} else {
